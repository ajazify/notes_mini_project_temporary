...
import 'package:notes/note_controler.dart';
...
class Notepage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Obx(() => Container(
              color: Color(controller.selectedColor.value), // Background color
              child: Column(
    ...
    showModalBottomSheet(
      ...
      builder: (BuildContext context) {
        return Container(
          ...
          height: 240, // Increase height for larger color options
          child: SingleChildScrollView(
            ...
            child: Row(
              ...
              children: [
                ...
                _buildColorOption(
                    const Color.fromARGB(255, 6, 5, 2), controller, context),
                // Pastel Grey
              ],
            ),
          ),
